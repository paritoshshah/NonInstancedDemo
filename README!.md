...
1. Once this template project opens, select your `NonInstancedDemo` project in the 
   Xcode *Project Navigator* panel.

2. Select the `NonInstancedDemo` target.

3. Select the *Build Phases* tab of the `NonInstancedDemo` target.
...
`NonInstancedDemoScene.m` file. To add your own 3D content, edit that method.

The `NonInstancedDemoScene.m` file is also where you add interactive behaviour,
